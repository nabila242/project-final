...
<head>
    ...
    <title>Register - SCRI Platform</title>
    ...
    <style>
        ...
        .btn-glow:hover { transform: translateY(-2px); box-shadow: 0 5px 15px rgba(245, 158, 11, 0.4); }
    </style>
</head>
<body>
    ...
    <div class="glass-card text-white">
        <div class="text-center mb-4">
            ...
            <p class="text-muted">Register to access the Admin Portal</p>
        </div>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <button type="submit" class="btn btn-glow w-100 text-white mb-3">Register Account</button>
            
            <div class="text-center">
                <a href="{{ route('login') }}" class="text-warning text-decoration-none small">Already have an account? Login here</a>
            </div>
        </form>
